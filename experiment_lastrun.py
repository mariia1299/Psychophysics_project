...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\mi\\Desktop\\psyc\\Project\\experiment_lastrun.py',
...
text_3 = visual.TextStim(win=win, name='text_3',
    text="In this task, you will be presented English words one by one.\nIf the word HAS a mistake, press 'SPACE'.\nIf the word DOES NOT HAS a mistake, do nothing.\n\nRespond within 3 seconds.",
    font='Open Sans',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text_3.status == STARTED:
        ...
        if tThisFlipGlobal > text_3.tStartRefresh + 11.0-frameTolerance:
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('short.xlsx'),
...
for thisTrial in trials:
    ...
    _key_resp_allKeys = []
    # keep track of which components have finished
    trialComponents = [text_2, key_resp]
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('long.xlsx'),
